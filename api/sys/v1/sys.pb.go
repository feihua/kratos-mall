...
var file_api_sys_v1_sys_proto_rawDesc = []byte{
	...
	0x14, 0x2e, 0x73, 0x79, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x12, 0x2e, 0x73, 0x79, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x48,
...
var file_api_sys_v1_sys_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_api_sys_v1_sys_proto_goTypes = []interface{}{
	(*HelloRequest)(nil), // 0: sys.v1.HelloRequest
	(*HelloReply)(nil),   // 1: sys.v1.HelloReply
}
var file_api_sys_v1_sys_proto_depIdxs = []int32{
	0, // 0: sys.v1.Greeter.SayHello:input_type -> sys.v1.HelloRequest
	1, // 1: sys.v1.Greeter.SayHello:output_type -> sys.v1.HelloReply
