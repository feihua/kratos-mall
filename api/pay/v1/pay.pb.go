...
var file_api_pay_v1_pay_proto_rawDesc = []byte{
	...
	0x14, 0x2e, 0x70, 0x61, 0x79, 0x2e, 0x76, 0x31, 0x2e, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x12, 0x2e, 0x70, 0x61, 0x79, 0x2e, 0x76, 0x31, 0x2e, 0x48,
	0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x0f, 0x5a, 0x0d, 0x61,
	0x70, 0x69, 0x2f, 0x70, 0x61, 0x79, 0x2f, 0x76, 0x31, 0x3b, 0x76, 0x31, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_api_pay_v1_pay_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_api_pay_v1_pay_proto_goTypes = []interface{}{
	(*HelloRequest)(nil), // 0: pay.v1.HelloRequest
	(*HelloReply)(nil),   // 1: pay.v1.HelloReply
}
var file_api_pay_v1_pay_proto_depIdxs = []int32{
	0, // 0: pay.v1.Greeter.SayHello:input_type -> pay.v1.HelloRequest
	1, // 1: pay.v1.Greeter.SayHello:output_type -> pay.v1.HelloReply
