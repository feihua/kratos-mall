...
func RegisterSysHTTPServer(s *http.Server, srv SysHTTPServer) {
	...
	r.POST("/api/sys/user/currentUser", _Sys_UserInfo0_HTTP_Handler(srv))
	...
	r.POST("/api/sys/", _Sys_ReSetPassword0_HTTP_Handler(srv))
	r.POST("/api/sys/", _Sys_UpdateUserStatus0_HTTP_Handler(srv))
