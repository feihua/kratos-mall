...
import (
	...
	oms2 "kratos-mall/app/front/admin/internal/biz/oms"
	pay2 "kratos-mall/app/front/admin/internal/biz/pay"
	pms2 "kratos-mall/app/front/admin/internal/biz/pms"
	sms2 "kratos-mall/app/front/admin/internal/biz/sms"
	sys2 "kratos-mall/app/front/admin/internal/biz/sys"
	ums2 "kratos-mall/app/front/admin/internal/biz/ums"
...
func initApp(confServer *conf.Server, registry *conf.Registry, confData *conf.Data, logger log.Logger) (*kratos.App, func(), error) {
	...
	userUseCase := sys2.NewUserUseCase(userRepo, logger)
